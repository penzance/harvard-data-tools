...
DATA_TOOLS_DIR = "{0}/java/mediasites_data_tools".format(GIT_BASE)
MEDIASITES_DATA_CLIENT_DIR = "{0}/java/mediasites_data_client".format(GIT_BASE)
...
compile_java(MEDIASITES_DATA_CLIENT_DIR)
run_generator()
