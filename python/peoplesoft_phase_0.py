...
RESULT_METADATA = os.environ['PEOPLESOFT_DATA_RESULT_FILE']
GIT_BASE = os.environ['HARVARD_DATA_TOOLS_BASE']
DUMP_ID = os.environ.get('PEOPLESOFT_DATA_DUMP_ID', None)
THREAD_COUNT = os.environ.get('DATA_THREAD_COUNT', 1)

MAIN_CLASS = 'edu.harvard.data.peoplesoft.cli.PeoplesoftDataCli'
