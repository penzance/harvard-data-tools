...
public class CanvasrestCodeGenerator extends CodeGenerator {
  ...
  public CanvasrestCodeGenerator(final String schemaVersion, final File gitDir, final File codeDir,
      final CanvasrestDataConfig config, final String runId) throws FileNotFoundException {
  ...
  UnexpectedApiResponseException, SQLException, VerificationException {
    ...
    final CanvasrestDataConfig config = CanvasrestDataConfig
        .parseInputFiles(CanvasrestDataConfig.class, configFiles, false);
    new CanvasrestCodeGenerator(schemaVersion, gitDir, dir, config, runId).generate();
  }
