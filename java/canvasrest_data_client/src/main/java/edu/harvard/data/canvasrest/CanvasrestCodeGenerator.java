...
public class CanvasrestCodeGenerator extends CodeGenerator {

  private static final Logger log = LogManager.getLogger();

  private static final int TRANFORMATION_PHASES = 2;

  private static final String PHASE_ZERO_PACKAGE = "edu.harvard.data.canvasrest.bindings.phase0";
  private static final String PHASE_ONE_PACKAGE = "edu.harvard.data.canvasrest.bindings.phase1";
  private static final String PHASE_TWO_PACKAGE = "edu.harvard.data.canvasrest.bindings.phase2";
  private static final String PHASE_THREE_PACKAGE = "edu.harvard.data.canvasrest.bindings.phase3";
  private static final String IDENTITY_HADOOP_PACKAGE = "edu.harvard.data.canvasrest.identity";

  public static final String PHASE_ZERO_TABLES_JSON = "canvasrest/phase0_redshift_tables.json";
  public static final String PHASE_ONE_IDENTIFIERS_JSON = "canvasrest/phase1_identifiers.json";
  public static final String PHASE_TWO_ADDITIONS_JSON = "canvasrest/phase2_schema_additions.json";
  public static final String PHASE_THREE_ADDITIONS_JSON = "canvasrest/phase3_schema_additions.json";
  public static final String FULL_TEXT_TABLES = "canvasrest/full_text_tables.json";
  ...
  public CanvasrestCodeGenerator(final String schemaVersion, final File gitDir, final File codeDir,
      final CanvasrestDataConfig config, final String runId, BootstrapParameters bootstrapParams ) throws FileNotFoundException {
  ...
  UnexpectedApiResponseException, SQLException, VerificationException {
    ...
    final CanvasrestDataConfig config = CanvasrestDataConfig
            .parseInputFiles(CanvasrestDataConfig.class, configFiles, false, bootstrapParamsString );
        log.info(args[5]);
    ...
    new CanvasrestCodeGenerator(schemaVersion, gitDir, dir, config, runId, bootstrapParams).generate();
  }
  ...
  protected GenerationSpec createGenerationSpec() throws IOException, VerificationException {
    ...
    spec.setJavaProjectName("canvasrest_generated_code");
    spec.setJavaTableEnumName("CanvasrestTable");
    ...
    spec.setHadoopIdentityManagerClass("CanvasrestIdentityHadoopManager");
    spec.setMainIdentifier(IdentifierType.HUID);
    spec.setHiveScriptDir(new File(gitDir, "hive/canvasrest"));
  ...
  private static DataSchema readSchema(final String version)
    ...
    final ClassLoader classLoader = CanvasrestCodeGenerator.class.getClassLoader();
    try (final InputStream in = classLoader
        .getResourceAsStream("canvasrest_schema_" + version + ".json")) {
