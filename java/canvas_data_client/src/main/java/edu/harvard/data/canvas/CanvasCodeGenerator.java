...
public class CanvasCodeGenerator {
  ...
  private static final String PHASE_ZERO_PACKAGE = CLIENT_PACKAGE + ".phase0";
  private static final String PHASE_ONE_PACKAGE = CLIENT_PACKAGE + ".phase1";
  private static final String PHASE_TWO_PACKAGE = CLIENT_PACKAGE + ".phase2";
  private static final String PHASE_THREE_PACKAGE = CLIENT_PACKAGE + ".phase3";
  ...
  UnexpectedApiResponseException, SQLException, VerificationException {
    ...
    final SchemaTransformer transformer = new SchemaTransformer(4);
    transformer.setTableEnumNames("CanvasTable");
    transformer.setClientPackage(CLIENT_PACKAGE);
    transformer.setPrefixes("", "Phase1", "Phase2", "Phase3");
    ...
    final File javaPhase3Dir = new File(javaSrcBase,
        PHASE_THREE_PACKAGE.replaceAll("\\.", File.separator));
    transformer.setJavaPackages(PHASE_ZERO_PACKAGE, PHASE_ONE_PACKAGE, PHASE_TWO_PACKAGE,
        PHASE_THREE_PACKAGE);
    transformer.setJavaSourceLocations(javaPhase0Dir, javaPhase1Dir, javaPhase2Dir, javaPhase3Dir);
    ...
    new MoveUnmodifiedTableGenerator(dir, transformer).generate();
  }
