...
import edu.harvard.data.data_tools.canvas.phase0.CanvasPhase0Verifier;
import edu.harvard.data.data_tools.canvas.phase1.CanvasPhase1Verifier;
import edu.harvard.data.data_tools.canvas.phase2.CanvasPhase2Verifier;
...
public class CanvasVerifyDumpCommand implements Command {
  ...
  @Option(name = "-d", usage = "Location of data files. Required for phases > 0.", metaVar = "hdfs://path/to/data", required = false)
