...
public abstract class CodeGenerator {
  ...
  public final List<DataSchema> transformSchema(final DataSchema base)
    ...
    if (overrides == null) {
      ...
      final ExtensionSchema overrideExtensions = ExtensionSchema.readExtensionSchema(overrides);
    ...
    final IdentitySchemaTransformer idTrans = new IdentitySchemaTransformer(inputSchema, identities,
        getMainIdentifier());
    final DataSchema deidentified = idTrans.transform();

    final DataSchema outputSchema = transformer.transform(deidentified, additions, false);
