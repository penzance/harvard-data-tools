...
public class LinksappCodeGenerator extends CodeGenerator {

  private static final Logger log = LogManager.getLogger();

  private static final int TRANFORMATION_PHASES = 2;

  private static final String PHASE_ZERO_PACKAGE = "edu.harvard.data.linksapp.bindings.phase0";
  private static final String PHASE_ONE_PACKAGE = "edu.harvard.data.linksapp.bindings.phase1";
  private static final String PHASE_TWO_PACKAGE = "edu.harvard.data.linksapp.bindings.phase2";
  private static final String PHASE_THREE_PACKAGE = "edu.harvard.data.linksapp.bindings.phase3";
  private static final String IDENTITY_HADOOP_PACKAGE = "edu.harvard.data.linksapp.identity";

  public static final String PHASE_ZERO_TABLES_JSON = "linksapp/phase0_redshift_tables.json";
  public static final String PHASE_ONE_IDENTIFIERS_JSON = "linksapp/phase1_identifiers.json";
  public static final String PHASE_TWO_ADDITIONS_JSON = "linksapp/phase2_schema_additions.json";
  public static final String PHASE_THREE_ADDITIONS_JSON = "linksapp/phase3_schema_additions.json";
  ...
  public LinksappCodeGenerator(final String schemaVersion, final File gitDir, final File codeDir,
      final LinksappDataConfig config, final String runId, BootstrapParameters bootstrapParams ) throws FileNotFoundException {
  ...
  UnexpectedApiResponseException, SQLException, VerificationException {
    ...
    final LinksappDataConfig config = LinksappDataConfig
        .parseInputFiles(LinksappDataConfig.class, configFiles, false, bootstrapParamsString );
        log.info(args[5]);
    ...
    new LinksappCodeGenerator(schemaVersion, gitDir, dir, config, runId, bootstrapParams).generate();
  }
  ...
  protected GenerationSpec createGenerationSpec() throws IOException, VerificationException {
    ...
    spec.setJavaProjectName("linksapp_generated_code");
    spec.setJavaTableEnumName("LinksappTable");
    ...
    spec.setHadoopIdentityManagerClass("LinksappIdentityHadoopManager");
    spec.setMainIdentifier(IdentifierType.HUID);
    spec.setHiveScriptDir(new File(gitDir, "hive/linksapp"));
  ...
  private static DataSchema readSchema(final String version)
    ...
    final ClassLoader classLoader = LinksappCodeGenerator.class.getClassLoader();
    try (final InputStream in = classLoader
        .getResourceAsStream("linksapp_schema_" + version + ".json")) {
