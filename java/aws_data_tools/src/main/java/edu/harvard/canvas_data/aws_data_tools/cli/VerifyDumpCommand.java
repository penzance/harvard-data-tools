...
import edu.harvard.canvas_data.aws_data_tools.canvas.Phase0Verifier;
import edu.harvard.canvas_data.aws_data_tools.canvas.Phase1Verifier;
import edu.harvard.canvas_data.aws_data_tools.canvas.Phase2Verifier;
import edu.harvard.canvas_data.aws_data_tools.canvas.Verifier;
...
public class VerifyDumpCommand implements Command {
  ...
  @Argument(index = 0, usage = "Verification phsae.", metaVar = "0", required = true)
  public int phase;
  ...
  public ReturnStatus execute(final DataConfiguration config)
    ...
    if (phase == 0) {
      ...
      verifier = new Phase0Verifier(dumpId, aws, factory, format);
    } else {
      if (dataDir == null) {
      ...
      switch (phase) {
      case 1:
        verifier = new Phase1Verifier();
        break;
      case 2:
        verifier = new Phase2Verifier();
        break;
      default:
