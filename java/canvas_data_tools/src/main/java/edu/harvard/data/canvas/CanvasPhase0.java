...
public class CanvasPhase0 extends Phase0 {
  ...
  private void checkSchema() throws VerificationException {
    ...
    validSchemas.add("4.2.7");
    validSchemas.add("4.2.6");
    validSchemas.add("4.2.5");
    validSchemas.add("4.2.4");
    validSchemas.add("4.2.3");
    validSchemas.add("4.2.2");
    validSchemas.add("4.2.1");
    validSchemas.add("4.2.0");
    validSchemas.add("4.1.0");
    validSchemas.add("4.0.0");
    validSchemas.add("3.0.1");
    validSchemas.add("3.0.0");
    validSchemas.add("2.0.0");
    validSchemas.add("1.18.0");
    validSchemas.add("1.17.2");
    validSchemas.add("1.17.1");
    validSchemas.add("1.17.0");
    validSchemas.add("1.16.2");
    validSchemas.add("1.16.1");
    validSchemas.add("1.16.0");
    validSchemas.add("1.15.0");
    validSchemas.add("1.14.0");
    validSchemas.add("1.13.3");
    validSchemas.add("1.13.2");
