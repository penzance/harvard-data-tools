...
public class ApiClient {
  ...
  public DataSchema getSchema(final String version)
      throws DataConfigurationException, UnexpectedApiResponseException, IOException {
    final JavaType type = typeFactory.constructType(MatterhornDataSchema.class);
    final MatterhornDataSchema schema = rest.makeApiCall("/api/schema/" + version, 200, type);
    return schema;
  }
