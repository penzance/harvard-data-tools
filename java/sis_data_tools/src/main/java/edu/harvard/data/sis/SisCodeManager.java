...
import edu.harvard.data.sis.identity.SisIdentityHadoopManager;

public class SisCodeManager extends CodeManager {

  private final SisIdentityHadoopManager identity;

  public SisCodeManager() {
    this.identity = new SisIdentityHadoopManager();
  }
  ...
  public DataConfig getDataConfig(final String configPathString, final boolean verify)
    ...
    return SisDataConfig.parseInputFiles(SisDataConfig.class, configPathString,
        verify);
  }
  ...
  public Phase0 getPhase0(final String configPathString, final String datasetId, final String runId,
    ...
    final SisDataConfig config = SisDataConfig
        .parseInputFiles(SisDataConfig.class, configPathString, false);
    return new SisPhase0(config, runId, exec);
  }
