...
import edu.harvard.data.enrollmentapp.bindings.phase0.Phase0CourseCatalog;
import edu.harvard.data.enrollmentapp.bindings.phase0.Phase0Classes;
import edu.harvard.data.enrollmentapp.bindings.phase0.Phase0CourseMap;
import edu.harvard.data.enrollmentapp.bindings.phase0.Phase0PrimeCourseEnroll;
import edu.harvard.data.enrollmentapp.bindings.phase0.Phase0CourseEnroll;
...
public class InputParser {
  ...
  public InputParser(final EnrollmentappDataConfig config, final AwsUtils aws,
