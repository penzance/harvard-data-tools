...
import edu.harvard.data.remoteapp.identity.RemoteappIdentityHadoopManager;

public class RemoteappCodeManager extends CodeManager {

  private final RemoteappIdentityHadoopManager identity;

  public RemoteappCodeManager() {
    this.identity = new RemoteappIdentityHadoopManager();
  }
  ...
  public DataConfig getDataConfig(final String configPathString, final boolean verify)
    ...
    return RemoteappDataConfig.parseInputFiles(RemoteappDataConfig.class, configPathString,
        verify);
  }
  ...
  public Phase0 getPhase0(final String configPathString, final String datasetId, final String runId,
    ...
    final RemoteappDataConfig config = RemoteappDataConfig
        .parseInputFiles(RemoteappDataConfig.class, configPathString, false);
    return new RemoteappPhase0(config, runId, exec);
  }
