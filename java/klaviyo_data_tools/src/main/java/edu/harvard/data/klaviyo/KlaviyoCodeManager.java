...
import edu.harvard.data.klaviyo.identity.KlaviyoIdentityHadoopManager;

public class KlaviyoCodeManager extends CodeManager {

  private final KlaviyoIdentityHadoopManager identity;

  public KlaviyoCodeManager() {
    this.identity = new KlaviyoIdentityHadoopManager();
  }
  ...
  public DataConfig getDataConfig(final String configPathString, final boolean verify)
    ...
    return KlaviyoDataConfig.parseInputFiles(KlaviyoDataConfig.class, configPathString,
        verify);
  }
  ...
  public Phase0 getPhase0(final String configPathString, final String datasetId, final String runId,
    ...
    final KlaviyoDataConfig config = KlaviyoDataConfig
        .parseInputFiles(KlaviyoDataConfig.class, configPathString, false);
    return new KlaviyoPhase0(config, runId, exec);
  }
