 ...
 * <P>
 * The main interfaces to this package are the {@link GenerationSpec} and
 * {@link CodeGenerator} classes. A client of this code should create a subtype
 * of {@code CodeGenerator} to manage the generation process, and should
 * populate a {@code SchemaTransformer} with
